...
class TestCase(TestCase):
    ...
    @patch('case.os.path.join', return_value='mocked_path')
    def test_save_label(self, mock_join, mock_nifti1image, mock_save):
        case = Case('test_case', 'test_dataset')
        case.image = MagicMock()
        ...
        mock_join.assert_called_once_with(data_raw, 'test_dataset', Folders.LABELS, 'test_case' + Endings.NIFTI)
        ...
        mock_save.assert_called_once_with(mock_nifti1image.return_value, 'mocked_path')
