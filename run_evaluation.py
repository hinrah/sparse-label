...
if __name__ == "__main__":
    ...
    parser.add_argument('-psp', default="nnUNetTrainer__nnUNetPlans__3d_fullres/crossval_results_folds_0_1_2_3_4", help="[Optional] the sub_path for the prediction. The default case is nnUNetTrainer__nnUNetPlans__3d_fullres/crossval_results_folds_0_1_2_3_4")
    parser.add_argument('-fp', default="Tr", help="[Optionial] folder postfix to distinct different datasets. The default is Tr as in imagesTr, labelsTr. This can be changed to evaluate different test datasets.")
