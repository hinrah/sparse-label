...
def save_results_to_csv(path_to_save, experiements):
    metrics_data = {
        ...
        "dice_background": [np.mean(result.dice_coefficients(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "dice_background_median": [np.median(result.dice_coefficients(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "hausdorff_distance_background": [np.mean(result.hausdorff_distances(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "hausdorff_distance_background_median": [np.median(result.hausdorff_distances(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "hausdorff_distance_95_background": [np.mean(result.hausdorff_distances_95(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "hausdorff_distance_95_background_median": [np.median(result.hausdorff_distances_95(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "average_countour_distance_background": [np.mean(result.average_contour_distances(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "average_countour_distance_background_median": [np.median(result.average_contour_distances(DatasetInfo.BACKGROUND)) for name, result in experiements],
        ...
        "mean_lumen_background_percentage": [np.mean(result.lumen_background_percentages()) for name, result in experiements],
        "median_lumen_background_percentage": [np.median(result.lumen_background_percentages()) for name, result in experiements],
